...
const HeroSection = () => {
    return (
        <div className='flex flex-col-reverse flex-col md:flex-row items-center justify-between container mx-auto mt-10'>
           <div className='w-4/6 md:text-left text-center'>
                <h2 className=' text-4xl sm:text-5xl md:text-5xl lg:text-7xl uppercase text-primary_black font-bold li sm:leading-relaxed mb-3'>The delight <br /> jumbo <span className='text-orange_light'>burger</span></h2>
                <p className='text-md  text-primary_black leading-snug mb-4'>
